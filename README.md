# Welcome to File Service Experience!
...
5. Then execute `STAGE=dev docker-compose up --build -d` to up all containers.
6. Finally, generates an **admin user**, add **roles** with **permissions** and get a **bucket** for **MinIO**.
